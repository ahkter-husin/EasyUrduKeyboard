...
public class LatinKeyboardView extends KeyboardView {
    ...
    protected boolean onLongPress(Key key) {
        ...
        if (key.codes[0] == Keyboard.KEYCODE_CANCEL) {
            ...
            // For Farsi Keyboard
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ض') {
            getOnKeyboardActionListener().onKey('۱', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ص') {
            getOnKeyboardActionListener().onKey('۲', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ث') {
            getOnKeyboardActionListener().onKey('۳', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ق') {
            getOnKeyboardActionListener().onKey('۴', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ف') {
            getOnKeyboardActionListener().onKey('۵', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'غ') {
            getOnKeyboardActionListener().onKey('۶', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ع') {
            getOnKeyboardActionListener().onKey('۷', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ه') {
            getOnKeyboardActionListener().onKey('۸', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'خ') {
            getOnKeyboardActionListener().onKey('۹', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ح') {
            getOnKeyboardActionListener().onKey('۰', null);
            return true;
        } else if (SoftKeyboard.mActiveKeyboard == "ur_PK" && key.codes[0] == 'ش') {
    ...
    void setSubtypeOnSpaceKey(final InputMethodSubtype subtype) {
        ...
        // urdukeyboard.setSpaceIcon(getResources().getDrawable(subtype.getIconResId()));
        invalidateAllKeys();
    }
        ...
        for (Key key : keys) {
            if (key.label != null) {
                ...
                if (key.label.toString().equals("q") || key.label.toString().equals("Q") || key.label.toString().equals("۱"))
                    ...
                    // for Farsi keyboards.
                else if (SoftKeyboard.mActiveKeyboard == "ur_PK") {
