 ...
 */
package com.zknapps.urdukeyboard.android;
...
import com.zknapps.urdukeyboard.R;
import com.zknapps.urdukeyboard.database.DatabaseManager;
...
import static com.zknapps.urdukeyboard.ThemeActivity.THEME_KEY;

/**
 * Example of writing an input method for a soft urdukeyboard.  This code is
 * focused on simplicity over completeness, so it should in no way be considered
 * to be a complete soft urdukeyboard implementation.  Its purpose is to provide
...
public class SoftKeyboard extends InputMethodService
     ...
     * a QWERTY urdukeyboard to Chinese), but may not be used for input methods
    ...
    public void onInitializeInterface() {
        if (mQwertyKeyboard != null) {
            // Configuration changes can happen after the urdukeyboard gets recreated,
    ...
    public View onCreateInputView() {
        ...
        // Close popup urdukeyboard when screen is touched, if it's showing
        ...
        // Apply the selected urdukeyboard to the input view.
    ...
    public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        switch (attribute.inputType & InputType.TYPE_MASK_CLASS) {
            ...
            case InputType.TYPE_CLASS_DATETIME:
                // Numbers and dates default to the symbols urdukeyboard, with
                // no extra features.
                mCurKeyboard = mSymbolsKeyboard;
                break;

            case InputType.TYPE_CLASS_PHONE:
                // Phones will also default to the symbols urdukeyboard, though
                // often you will want to have a dedicated phone urdukeyboard.
                mCurKeyboard = mPhoneKeyboard;
                break;

            case InputType.TYPE_CLASS_TEXT:
                // This is general text editing.  We will default to the
                // normal alphabetic urdukeyboard, and assume that we should
                ...
                // to decide whether our alphabetic urdukeyboard should start out
                // shifted.
            ...
            default:
                ...
                // urdukeyboard with no special features.
                mCurKeyboard = getSelectedSubtype();
                updateShiftKeyState(attribute);
        }
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
        ...
        // Dismiss the Emoticons before showing the soft urdukeyboard.
        closeEmoticons();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                ...
                // However, our urdukeyboard could be showing a pop-up window
            ...
            default:
                ...
                // text being entered with a hard urdukeyboard, we need to process
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        // urdukeyboard, we need to process the up events to update the meta key
    ...
    /**
     * Helper to update the shift state of our urdukeyboard based on the initial
     * editor state.
     */
...
//    }
    ...
    public void showEmoticons() {
        ...
        if (layoutInflater != null) {
            ...
            // If the text urdukeyboard closes, also dismiss the emoji popup
