...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
	...
	/**
	 * Constructor
	 * @param rootView	The top most layout in your view hierarchy. The difference of this view and the screen height will be used to calculate the urdukeyboard height.
	...
	/**
	 * Set the listener for the event of urdukeyboard opening or closing.
	 */
	 ...
	 * NOTE: Since, the soft urdukeyboard sizes are variable on different android devices, the
	 * library needs you to open the soft urdukeyboard atleast once before calling this function.
	...
	/**
	 * Use this function when the soft urdukeyboard has not been opened yet. This
	 * will show the emoji popup after the urdukeyboard is up next time.
	...
	/**
	 * 
	 * @return Returns true if the soft urdukeyboard is open, false otherwise.
	 */
	...
	/**
	 * Call this function to resize the emoji popup according to your soft urdukeyboard size
	 */
	...
	private View createCustomView() {
		...
		// Hide Emoticons with urdukeyboard icon.
	 ...
	 * It cyclically runs a clickListener, emulating urdukeyboard-like behaviour. First
